        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-xl border border-gray-100 dark:border-gray-700 p-8 text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
                    ...
                    <div class="p-6 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-transparent hover:border-green-500/30 transition-colors">
                    ...
                    <div class="p-6 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-transparent hover:border-amber-500/30 transition-colors">
                ...
                <div class="mt-10 pt-6 border-t border-gray-100 dark:border-gray-700">
                    <a href="{{ route('solar.pdf', $resultado->id_resultado) }}" 
                       class="inline-flex items-center px-8 py-4 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-lg font-black text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white transition-all shadow-md active:scale-95 group">
