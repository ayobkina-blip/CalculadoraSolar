<x-main-layout>
    ...
    <div class="relative overflow-hidden bg-white dark:bg-gray-900 pt-16 pb-32">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center">
                ...
                <h1 class="text-6xl md:text-8xl font-black text-gray-900 dark:text-white tracking-tighter mb-8">
                    Tu tejado es una <br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-600">mina de oro.</span>
                </h1>
    ...
    {{-- 2. FEATURES GRID: ¿Por qué nosotros? --}}
    <div class="py-24 bg-gray-50 dark:bg-gray-800/50">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 hover:border-amber-500/50 transition-colors">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">No usamos promedios nacionales. Utilizamos coordenadas exactas de la Ribera Alta para una precisión milimétrica.</p>
                </div>
                <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 hover:border-amber-500/50 transition-colors">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Incluimos la degradación de los paneles y el precio actual de la luz para decirte cuándo recuperarás tu inversión.</p>
                </div>
                <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 hover:border-amber-500/50 transition-colors">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Obtén un informe técnico detallado listo para presentar a instaladores o solicitar subvenciones municipales.</p>
                </div>
            </div>
        </div>
    </div>

    {{-- 3. INTERACTIVE SECTION: El proceso --}}
        ...
        <div class="space-y-20">
            <div class="flex flex-col md:flex-row gap-12 items-center">
                <div class="flex-1">
                    ...
                    <p class="mt-4 text-gray-600 dark:text-gray-400">Nuestro sistema calcula el área útil descontando obstáculos y optimizando la inclinación necesaria para la latitud de la Comunidad Valenciana.</p>
                </div>
                <div class="flex-1 bg-gray-100 dark:bg-gray-800 h-48 w-full rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-700 flex items-center justify-center">
                    <svg class="w-16 h-16 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5z"></path></svg>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row-reverse gap-12 items-center">
                <div class="flex-1">
                    ...
                    <p class="mt-4 text-gray-600 dark:text-gray-400">Cruzamos tus datos con el histórico de radiación mensual. Sabrás exactamente cuánto producirás en el mes más nublado de diciembre.</p>
                </div>
                <div class="flex-1 bg-gray-100 dark:bg-gray-800 h-48 w-full rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-700 flex items-center justify-center">
                    <svg class="w-16 h-16 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                </div>
            </div>
        </div>
    </section>

    {{-- 4. FINAL CTA: El empujón final --}}
    <div class="max-w-7xl mx-auto px-6 mb-20">
        <div class="bg-[#1e293b] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <h2 class="text-4xl md:text-5xl font-black text-white mb-8 relative z-10">
                Únete a los más de <span class="text-amber-500">{{ $conteo ?? '100+' }}</span> usuarios que ya han calculado su ahorro.
            </h2>
